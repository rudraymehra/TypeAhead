...
async function start() {
  ...
  // --- GET /cache/debug?prefix=<p> → which node owns it + hit/miss ---
  ...
  // --- GET /stats → everything: DB rows+IO, cache hit rate, latency, batching ---
  ...
  // --- graceful shutdown: flush the batch buffer BEFORE exit (zero loss) ---
